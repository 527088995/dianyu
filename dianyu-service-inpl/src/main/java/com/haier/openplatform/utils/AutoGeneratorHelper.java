...
import com.haier.openplatform.generator.AutoGenerator;


/**
 *
 * 自动生成映射工具类
 *参考url:https://blog.csdn.net/u011844490/article/details/77827787
 *
 * @author hubin
 *
 */
...
gc.setOutputDir("F:\\gitTest\\test");//此处为本项目src所在路径（代码生成器输出路径）
...
dsc.setUsername(rb.getString("userName"));//数据库连接用户名
dsc.setPassword(rb.getString("passWord"));//数据库连接
...
pc.setParent(rb.getString("parent"));// 自定义包路径com.haier.openplatform
